...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2023-07-16T10:30').blur().should('have.value', '2023-07-16T10:30');

      cy.get(`[data-cy="endDate"]`).type('2023-07-15T17:27').blur().should('have.value', '2023-07-15T17:27');
